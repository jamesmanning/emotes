...
class EmoteEffectsModifier {
    applyFlagsFromObjectToEmote(emoteData : IEmoteDataEntry, emoteObject: EmoteObject, emoteHtml: string): string {
    ...
    wrapEmoteHeight(emoteHtml: string, height: number): string {
